...
export const startConversation = (text, workspaceContext = null, modelPref = null, buildProfile = null, useVerifier = true) => request("/api/v1/conversations", {
  method: "POST", body: JSON.stringify({ text, workspaceContext, modelPref, buildProfile, useVerifier: useVerifier !== false }),
});
