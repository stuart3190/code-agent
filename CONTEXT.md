...
the current local unit redacts diagnostics at the persistence boundary and adds prompt/source
retention controls. Sharp process isolation remains explicitly deferred to the build-worker PR. Builder V1
