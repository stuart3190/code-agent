      ...
      <section className="files-main">
        <header className="files-toolbar">
          ...
          <div className="toolbar-actions">
            <button aria-label="New folder (fixture)" onClick={createFolder}><FolderPlus /> <span>New folder</span></button>
            <button aria-label="Fixture upload (local simulation)" onClick={upload}><UploadSimple /> <span>Fixture upload</span></button>
        ...
        <div className={`file-list view-${view}`} role="list" aria-label={`${location} fixture contents`}>
